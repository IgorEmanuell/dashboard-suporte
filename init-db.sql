-- Script de inicialização do banco PostgreSQL para Dashboard de Suporte
-- Este script cria todas as tabelas e dados iniciais necessários
...
-- Inserir alguns tickets de exemplo para teste
